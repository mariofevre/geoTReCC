...
$Log['data']['busquedatipo']='game';


$query="
	SELECT 
		id, id_p_indicadores_indicadores, ic_p_est_02_marcoacademico, 
		nombre, presentacion as descripcion, costounitario, limiteunitarioporturno,
		zz_borrada, 
		ref_game_sesiones.*
	FROM 
	...
	WHERE 
        zz_borrada = '0'
       	AND
		  (
			  ref_game_sesiones.nombre LIKE '%".$_POST['busqueda']."%'
			  OR
			  ref_game_sesiones.presentacion LIKE '%".$_POST['busqueda']."%'
		  )
 ";
