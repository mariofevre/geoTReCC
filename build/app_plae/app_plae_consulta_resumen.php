...
$HOY=date("Y-m-d");
	...
	$query="
		SELECT 
			id, mes, ano, fechaU, 
			totPLAn1, totPLAn2, totPLAn3, 
			alertaPLAn1, alertaPLAn2, alertaPLAn3,
			alertaPLAn1_Tx, alertaPLAn2_Tx, alertaPLAn3_Tx
			FROM PANestadisticasPLA
	...
	if(isset($Log['data']['fechaU'])){
		$hace=number_format(((time()-$Log['data']['fechaU'])/60/60),0);
	}else{
		$hace=9999;
	}
	$Log['data']['antig']=$hace;
