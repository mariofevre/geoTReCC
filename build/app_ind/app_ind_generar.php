...
$query = "INSERT INTO $DB.ref_indicadores_indicadores
            (usu_autor, ic_p_est_02_marcoacademico, zz_borrada, zz_publicada, nombre)
          VALUES
            ('".$idUsuario."', '".$_POST['codMarco']."', '0', '0', '')
          RETURNING ID;
";
...
$Log['tx'][]= "Creado indicador id: ".$fila['id'];
$Log['data']['id']=$fila['id'];
$Log['res']="exito";
terminar($Log);
