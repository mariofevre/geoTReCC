...
if($Log['data']['periodicidad']=='anual'){
	...
	if($_POST['mes']!='1'){
		$origen_mes=$_POST['mes']-1;
		$origen_ano=$_POST['ano'];
	}else{
		$origen_mes='12';
		$origen_ano=$_POST['ano']-1;
	}
...
/* geom, texto1, texto2, texto3, texto4, texto5, 
	...
	$query="
		...
		LEFT JOIN 
			$DB.ref_indicadores_indicadores ON ref_indicadores_indicadores.id_p_ref_capasgeo = ref_capasgeo_registros.id_ref_capasgeo
		LEFT JOIN 
		...
		AND
			ref_indicadores_indicadores.id='".$Log['data']['idInd']."'
		AND
