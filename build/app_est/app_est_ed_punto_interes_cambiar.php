...
if($_POST['idp']==0){
	...
	UPDATE 
		$DB.per_02_marcoacademico
		
		SET 
			centro = ST_GeomFromText('".$_POST['geotx']."', 3857)
	...
	$Log['tx'][]='modificado centro';
	
}elseif($_POST['idp']>0){
	$query="	
		UPDATE
			$DB.per_02_marcoacademicio_sitios
			SET	
				nombre = '".$_POST['nombre']."',
				centro = ST_GeomFromText('".$_POST['geotx']."', 3857)
	...
	$Log['tx'][]='modificado sitio '.$_POST['idp'];
}
