...
$query="  
	...
	LEFT JOIN
		$DB.ref_capasgeo_registros ON ref_capasgeo_registros.zz_copia_de = ref_rele_registros.id_p_ref_capas_registros
	WHERE
...
$query="   
	...
	LEFT JOIN
		$DB.ref_rele_campos ON ref_rele_campos.zz_copia_de = ref_rele_registros_datos.id_p_ref_rele_campos
		
	LEFT JOIN
		$DB.ref_rele_registros ON ref_rele_registros.zz_copia_de = ref_rele_registros_datos.id_p_ref_rele_registros		
