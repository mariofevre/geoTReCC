...
$query="SELECT 
	...
	AND
		id_ref_02_pseudocarpetas='".$_POST['idcarp']."'
";
...
if($_POST['nuevoestado']=='excluido'){
    if(pg_num_rows($ConsultaProy)!=0){
        $query="DELETE FROM $DB.sis_planif_pseudocarpetas
                WHERE 
                        id_sis_planif_plan='".$_POST['idit']."'
                AND
                        id_ref_02_pseudocarpetas='".$_POST['idcarp']."'
    ...
    if(pg_num_rows($ConsultaProy)==0){
        $query="INSERT INTO $DB.sis_planif_pseudocarpetas
                        (id_sis_planif_plan, 
                        id_ref_02_pseudocarpetas, 
                        comentario)
                VALUES (
