...
$query="
	...
	WHERE
		...
		AND
 	  (
	 	  ref_02_pseudocarpetas.nombre LIKE '%".$_POST['busqueda']."%'
	 	  OR
	 	  ref_02_pseudocarpetas.descripcion LIKE '%".$_POST['busqueda']."%'
	  )
";
...
$Log['data']['carpetas']=array();

while ($fila=pg_fetch_assoc($ConsultaProy)){	
	$Log['data']['carpetas'][$fila['id']]=$fila;
}
...
$query="
	SELECT 
		...
		ref_01_documentos.ic_p_est_02_marcoacademico, 
