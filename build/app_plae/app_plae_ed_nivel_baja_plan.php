...
//TODO control de integridad nivel_dest, menor o igual que nivel
//TODO control de integridad id_dest, no descendiente de id

$query = "
	SELECT 
		*
	FROM ".$_POST['nivel_dest']."
...
if($_POST['nivel_dest']=='PLAn1'){
	$_POST['nivel_destME2']='PLAn3';
	$_POST['nivel_destME1']='PLAn2';
	$_POST['nivel_destMA1']=null;
	$_POST['nivel_destMA2']=null;
}elseif($_POST['nivel_dest']=='PLAn2'){
	$_POST['nivel_destME2']=null;
	$_POST['nivel_destME1']='PLAn3';
	$_POST['nivel_destMA1']='PLAn1';
	$_POST['nivel_destMA2']=null;
}elseif($_POST['nivel_dest']=='PLAn3'){		
	$_POST['nivel_destME2']=null;
	$_POST['nivel_destME1']=null;
	$_POST['nivel_destMA1']='PLAn2';
	$_POST['nivel_destMA2']='PLAn1';
}


$Log['data']['nnivel']=$_POST['nivel_destME1'];

$query=" 
	INSERT INTO 
	`paneles`.`".$_POST['nivel_destME1']."`
	(
		`zz_AUTOPANEL`,
		zz_preliminar,
		`id_p_".$_POST['nivel_dest']."`,
		nombre,
		numero,
		descripcion,
		id_p_GRAactores,		
...
$query="
	INSERT INTO PLAestados(
		nombre, desde, zz_AUTOPANEL, id_p_".$_POST['nivel_destME1']."
	)
	SELECT 
...
$query="
	INSERT INTO PLAcategoriasVal(
		id_p_PLAcategorias, valor, zz_AUTOPANEL, id_p_".$_POST['nivel_destME1']."
	)
	SELECT 
...
foreach($SubComponentes as $subid => $subdat){
	...
	$query=" 
		INSERT INTO 
		`paneles`.`".$_POST['nivel_destME2']."`
		(
			`zz_AUTOPANEL`,
			zz_preliminar,
			`id_p_".$_POST['nivel_destME1']."`, 
			nombre,
			numero,
			descripcion,
			id_p_GRAactores,			
	...
	$query="
		INSERT INTO PLAestados(
			nombre, desde, zz_AUTOPANEL, id_p_".$_POST['nivel_destME2']."
		)
		SELECT 
	...
	$query="
	INSERT INTO PLAcategoriasVal(
			id_p_PLAcategorias, valor, zz_AUTOPANEL, id_p_".$_POST['nivel_destME2']."
		)
		SELECT 
