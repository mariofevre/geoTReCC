...
if($capa['autor']!=$idUsuario){
	$Log['mg'][]='Esta capa pertenece a otre usuarie. Si querés una versión personalizada tendrás que generar una copia.';
	$Log['res']='err';
	terminar($Log);		
}
